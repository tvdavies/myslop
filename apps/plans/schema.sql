-- myslop-plans metadata. Local bootstrap:
--   bunx wrangler d1 execute myslop-plans --local --file schema.sql
-- Production schema is applied by the platform from migrations/.
