...
const skillOut = new URL("../plugins/temp-email/skills/temp-email/SKILL.md", import.meta.url);
await Bun.write(skillOut, await Bun.file(skillIn).text());
console.log("mirrored src/skill.md -> plugins/temp-email/skills/temp-email/SKILL.md");
